...
\item Panel bên phải phía dưới dùng để điền vào các phát biểu được gợi ý trong sơ đồ ở phía trên về các cá thể thuộc lớp đang được chọn ở bên phải.
\end{enumerate}}
% Demo Sheet
...
\end{table}
\section{Các tính năng của UIT-OWL Editor}
