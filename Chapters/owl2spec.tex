...
Các đặc tính được sử dụng trong OWL 2 để tạo thành các mô tả đặc tính.

% Object Property Expression
\subsubsection{Mô tả đặc tính đối tượng (Object Property Expression)}
Đặc tính đối tượng được sử dụng trong OWL 2 để tạo thành các mô tả đặc tính đối tượng (object property expression), miêu tả các mối quan hệ giữa các cặp cá thể. Chúng được miêu tả trong bản thảo chi tiết về cấu trúc của OWL 2 như trong hình sau.
\begin{figure}[h!]
	\centering
	\includegraphics[width=110mm]{Figures/object_property_expression.png}
	\caption{Mô tả đặc tính đối tượng OWL 2\label{overflow}}
\end{figure}
Như được thể hiện trong hình, OWL 2 hỗ trợ 2 loại mô tả đặc tính đối tượng. Đặc tính đối tượng là dạng đơn giản của mô tả đặc tính đối tượng, đặc tính đối tượng nghịch đảo (inverse object properties) cho phép thể hiện các mối quan hệ 2 chiều giữa mô tả các lớp và các phát biểu.
...
Tương đương với mô tả đặc tính đối tượng, phác thảo cấu trúc chi tiết của OWL2 cũng giới thiệu định nghĩa mô tả đặc tính dữ liệu  (data property expressions), nhằm biểu diễn mối quan hệ giữa một cá thể và một trực nghĩa. Cấu trúc của mô tả đặc tính dữ liệu thể hiện trong hình bên. Như chúng ta thấy mô tả đặc tính dữ liệu cũng chính là đặc tính dữ liệu, người ta tạo ra cấu trúc như vậy nhằm tạo thuận lợi cho nhu cầu mở rộng sau này cho mô tả đặc tính dữ liệu.
\begin{figure}[h!]
	\centering
...
Một danh sách liệt kê với cú pháp $DataOneOF( lt_{1} ... lt_{n} $ chứa chính xác các trực nghĩa $lt_{i}$ với $1 <= i <= n$. Số kết quả chỉ duy nhất là 1 \textit{"oneOf"}
