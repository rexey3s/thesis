...
\\
\paragraph{Kết luận} Tính năng vừa trình bày \textit{Tìm tất cả các giải thích cho kết quả suy luận}, kĩ thuật \textit{Axiom Pinpoint} được đã được áp dụng trong thư viện lặp trình OWL-API \cite{owlapi} sẽ được chúng em giới thiệu trong chương kế.
