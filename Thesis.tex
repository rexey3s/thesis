...
\input{Chapters/open_world_assumption}

\input{Chapters/owl2spec}

\input{Chapters/swrl_reasoning}

\input{Chapters/inconsistency_reasons}  % Các nguyên nhân dẫn đến tính thiếu nhất quán  trong ontology
\input{Chapters/repair_inconsistency}  % Giải pháp sửa chữa ontology
