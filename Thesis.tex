...
%\lhead{\emph{Khóa luận tốt nghiệp 1-2015}} 
 % Set the left side page header to "Symbols"

%\lhead{\emph{Danh sách các biểu tượng}}  % Set the left side page header to "Symbols"
...
%% ----------------------------------------------------------------
%% Quy ước của trường Đại học Công Nghệ Thông Tin
...
\input{Chapters/semanticweb_intro}

\input{Chapters/owl2spec}

\input{Chapters/swrl_reasoning}

\input{Chapters/ontology_consistency}

\input{Chapters/owlapi_vaadin}

\input{Chapters/uit_owleditor}
...
\input{Appendices/open_world_assumption}
%\input{Appendices/semanticweb_appeddix}
...
\bibliographystyle{IEEEtranN}  % Use the "IEEEtranN" BibTeX style for formatting the Bibliography
